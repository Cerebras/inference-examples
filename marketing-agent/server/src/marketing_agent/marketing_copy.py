...
class CopyPiece:
    ...
    def __init__(
        ...
        self._title_key = copy_classes.title_key
    ...
    async def initialize(self):
        ...
        metadata = await self._llm.query_structured(
            ...
            DEMOGRAPHICS=json.dumps(self._audience.demographics),
        ...
        if isinstance(metadata, str):
            ...
            metadata_string = json.dumps(metadata.model_dump())
    ...
    async def improve(self):
        ...
        content = await self._llm.query_structured(
            ...
            TASK=(
                ...
                "based on the EVALUATION. Please only return the improved content."
            ),
        )
